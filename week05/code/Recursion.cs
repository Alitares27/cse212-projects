...
public static class Recursion
{
    ...
    public static void PermutationsChoose(List<string> results, string letters, int size, string word = "")
    {
        ...
        // Recursive case: iterate through each letter and append it to the current word
    ...
    public static decimal CountWaysToClimb(int s, Dictionary<int, decimal>? remember = null)
    {
        ...
        // Check if the result for this step count is already computed
    ...
    public static void WildcardBinary(string pattern, List<string> results)
    {
        ...
        // If there are no wildcards left, we have a complete binary string
        if (index == -1)
        {
            results.Add(pattern);
            return;
    ...
    public static void SolveMaze(List<string> results, Maze maze, int x = 0, int y = 0, List<(int, int)>? currPath = null)
    {
        ...
        else
        {
            ...
            SolveMaze(results, maze, x + 1, y, new List<(int, int)>(currPath)); // derecha
            SolveMaze(results, maze, x - 1, y, new List<(int, int)>(currPath)); // izquierda
            SolveMaze(results, maze, x, y + 1, new List<(int, int)>(currPath)); // abajo
            SolveMaze(results, maze, x, y - 1, new List<(int, int)>(currPath)); // arriba
        }
